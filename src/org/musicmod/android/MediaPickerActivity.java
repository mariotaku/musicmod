...
import org.musicmod.android.util.SortCursor;

public class MediaPickerActivity extends ListActivity implements Constants {
	...
	public void init() {
		...
		PickListAdapter adapter = new PickListAdapter(this, R.layout.track_list_item, mCursor,
				new String[] {}, new int[] {});
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (Intent.ACTION_GET_CONTENT.equals(action)) {
			...
			if (type.startsWith("video")) {
				...
				mediaId = mCursor
						.getLong(mCursor.getColumnIndexOrThrow(MediaStore.Video.Media._ID));
			} else {
				uri = MediaStore.Audio.Media.EXTERNAL_CONTENT_URI;
				mediaId = mCursor
						.getLong(mCursor.getColumnIndexOrThrow(MediaStore.Audio.Media._ID));
			}
	...
	static class PickListAdapter extends SimpleCursorAdapter {
		...
		public void bindView(View view, Context context, Cursor cursor) {
			...
			;
			if (text != null
					&& (text.startsWith("audio") || text.equals("application/ogg") || text
