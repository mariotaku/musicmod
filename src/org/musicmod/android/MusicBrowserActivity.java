...
public class MusicBrowserActivity extends Activity implements Constants {
	...
	public void onCreate(Bundle icicle) {
		...
		int activeTab = new SharedPrefs(this).getIntState(STATE_KEY_ACTIVETAB, R.id.artisttab);
	...
	private ServiceConnection autoshuffle = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName classname, IBinder obj) {
			...
			IMusicPlaybackService serv = IMusicPlaybackService.Stub.asInterface(obj);
			if (serv != null) {
				try {
					serv.setShuffleMode(MusicPlaybackService.SHUFFLE_AUTO);
